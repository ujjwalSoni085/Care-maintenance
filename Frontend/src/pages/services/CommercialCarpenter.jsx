    ...
    <div className="bg-[#fafafa] min-h-screen text-gray-900 font-sans selection:bg-blue-200">
      ...
      <section className="relative pt-16 pb-14 lg:pt-20 lg:pb-22 overflow-hidden px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783058980/care_maintenance/frontend_assets/services/carpenter_15.webp" alt="Commercial Carpentry" className="w-full h-full object-cover" />
            {/* Floating Stats */}
            <motion.div 
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-gray-200 relative">
              <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783058979/care_maintenance/frontend_assets/services/carpenter_12.webp" alt="Expert Carpentry" className="w-full h-full object-cover" />
            </div>
      ...
      <section className="py-10 lg:py-16 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783058976/care_maintenance/frontend_assets/services/carpenter_11.webp" alt="Recent Project" className="w-full h-full object-cover absolute inset-0 z-0" />
          ...
          <div className="flex flex-col gap-8">
            ...
            >
              <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783058973/care_maintenance/frontend_assets/services/carepenter_13.webp" alt="Recent Project" className="w-full h-full object-cover absolute inset-0 z-0" />
            ...
            <motion.div 
              ...
              className="group cursor-pointer rounded-[2rem] overflow-hidden relative h-[284px] bg-gray-200"
            >
              <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783058982/care_maintenance/frontend_assets/services/carpenter_image_13.webp" alt="Recent Project" className="w-full h-full object-cover absolute inset-0 z-0" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 to-transparent flex flex-col justify-end p-8 z-10">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
            ...
            <div className="w-full lg:w-[40%] order-1 lg:order-2">
              <div className="relative w-full aspect-[4/5] rounded-[24px] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.08)] bg-gray-200">
                <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783058980/care_maintenance/frontend_assets/services/carpenter_15.webp" alt="Carpentry Details" className="w-full h-full object-cover absolute inset-0 z-0" />
