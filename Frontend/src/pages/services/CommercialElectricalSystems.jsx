...
import { 
  ...
  Star, Phone, Mail, Award, Factory, Power
} from 'lucide-react';
...
const CommercialElectricalSystems = () => {
  ...
  return (
    <div className="bg-[#fafafa] min-h-screen text-gray-900 font-sans selection:bg-blue-200">
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.h1 variants={fadeInUp} className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-red-600 leading-[1.15] tracking-tight mb-6 min-h-[140px] md:min-h-[180px] lg:min-h-[220px] max-w-2xl text-balance">
              Commercial Electrical, <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">Safe & Simplified</span>
            </motion.h1>
            <motion.p variants={fadeInUp} className="text-lg text-gray-600 mb-10 leading-relaxed max-w-xl">
              Elevate your facility's infrastructure with proactive maintenance, emergency response, and modern electrical solutions tailored for businesses.
            </motion.p>
          ...
          >
            <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059016/care_maintenance/frontend_assets/services/elect_1.webp" alt="Commercial Electrical" className="absolute inset-0 w-full h-full object-cover z-0" />
            {/* Floating Stats */}
            <motion.div 
      ...
      <section className="py-12 lg:py-24 max-w-7xl mx-auto px-4 lg:px-8">
        ...
        >
          <h2 className="text-3xl lg:text-5xl font-semibold tracking-tight mb-6 text-red-600">Comprehensive Commercial Electrical Solutions</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">Providing efficient and dependable electrical services for properties of all types and sizes, with a commitment to quality, safety, and long-term performance</p>
        </motion.div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            { icon: Zap, title: 'Panel Upgrades & Installations', desc: 'Industrial-grade electrical panels for new constructions and existing facility upgrades.' },
            { icon: TrendingUp, title: 'Preventative Maintenance', desc: 'Scheduled inspections to prevent costly operational downtime and ensure safety compliance.' },
            { icon: Lightbulb, title: 'Commercial Lighting Systems', desc: 'Installation and servicing of high-efficiency LED and smart lighting systems.' },
            { icon: Power, title: 'Backup Generator Systems', desc: 'Testing, repair, and installation to ensure your business stays powered during outages.' },
            { icon: Shield, title: 'Fault Detection', desc: 'Advanced technology to locate hidden electrical faults instantly and safely.' },
            { icon: Clock, title: 'Emergency Response', desc: 'Priority dispatch for commercial accounts, minimizing downtime and disruption.' }
          ].map((service, i) => (
            <motion.div 
              key={i}
              initial="hidden" whileInView="visible" viewport={{ once: true }}
      ...
      {/* 4.Comprehensive Commercial Electrical Services  */}
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-gray-200 flex items-center justify-center relative">
              <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059018/care_maintenance/frontend_assets/services/elect_2.webp" alt="Service" className="absolute inset-0 w-full h-full object-cover" />
            </div>
            <div className="absolute -right-12 top-1/2 -translate-y-1/2 bg-white/80 backdrop-blur-xl p-8 rounded-3xl border border-white/50 shadow-2xl hidden md:block max-w-xs transition-all duration-500 group-hover:-translate-y-[55%] group-hover:shadow-blue-500/20 z-10">
              <Award className="w-10 h-10 text-blue-600 mb-4" />
              <h4 className="font-bold text-xl mb-2">Licensed & Insured</h4>
              <p className="text-sm text-gray-600">Fully compliant with state commercial building codes and electrical regulations.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              We understand that commercial electrical isn't just about fixing wires—it's about protecting your assets, ensuring safety code compliance, and keeping your operations powered.
            </p>
      ...
      <section className="py-10 lg:py-16 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059019/care_maintenance/frontend_assets/services/elect_3.webp" alt="Project 1" className="absolute inset-0 w-full h-full object-cover z-0 transition-transform duration-700 group-hover:scale-110" />
            <div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 via-transparent to-transparent flex flex-col justify-end p-10 z-10">
              ...
              <h3 className="text-3xl font-bold text-white mb-2">Complete Rewiring</h3>
              <p className="text-gray-200 line-clamp-2">Upgraded a 10-story office building with modern electrical systems with zero daytime disruption.</p>
            </div>
          </motion.div>
          ...
          <div className="flex flex-col gap-8">
            ...
            >
              <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059020/care_maintenance/frontend_assets/services/elect_4.webp" alt="Project 2" className="absolute inset-0 w-full h-full object-cover z-0 transition-transform duration-700 group-hover:scale-110" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 to-transparent flex flex-col justify-end p-8 z-10">
                ...
                <h3 className="text-xl font-bold text-white">Commercial Kitchen Lighting</h3>
              </div>
            </motion.div>
            <motion.div 
              ...
              className="group cursor-pointer rounded-[2rem] overflow-hidden relative h-[284px] bg-gray-200 flex items-center justify-center"
            >
              <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059021/care_maintenance/frontend_assets/services/elect_5.webp" alt="Project 3" className="absolute inset-0 w-full h-full object-cover z-0 transition-transform duration-700 group-hover:scale-110" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 to-transparent flex flex-col justify-end p-8 z-10">
                <div className="bg-white/20 backdrop-blur-md w-fit px-4 py-1 rounded-full text-white text-sm mb-3">Industrial Facility</div>
                <h3 className="text-xl font-bold text-white">Generator Installation</h3>
              </div>
            </motion.div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
            ...
            <div className="w-full lg:w-[40%] order-1 lg:order-2">
              <div className="relative w-full aspect-[4/5] rounded-[24px] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.08)] bg-gray-200 flex items-center justify-center">
                <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059022/care_maintenance/frontend_assets/services/elect_6.webp" alt="FAQ" className="absolute inset-0 w-full h-full object-cover z-0" />
            ...
            <div className="w-full lg:w-[60%] order-2 lg:order-1">
              ...
              <div className="space-y-4">
                {[
                  { q: 'Do you offer emergency services for commercial buildings?', a: 'Yes, we provide 24/7 emergency response for our commercial clients with priority dispatch to minimize downtime.' },
                  ...
                  { q: 'Are your technicians licensed and insured?', a: 'Yes, all our commercial electricians are fully licensed, bonded, and insured, carrying premium commercial liability coverage.' },
        ...
        <div className="max-w-6xl mx-auto bg-gradient-to-br from-gray-900 to-blue-900 rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 text-lg lg:text-xl max-w-2xl mx-auto mb-10">
              Get in touch with our commercial specialists today to discuss your electrical needs and receive a customized proposal.
            </p>
...
export default CommercialElectricalSystems;
