    ...
    <div className="bg-[#fafafa] min-h-screen text-gray-900 font-sans selection:bg-blue-200">
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.h1 variants={fadeInUp} className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-red-600 leading-[1.15] tracking-tight mb-6 min-h-[140px] md:min-h-[180px] lg:min-h-[220px] max-w-2xl text-balance">
              Commercial Pest Control, <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">Clean & Simplified</span>
            </motion.h1>
          ...
          >
            <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059043/care_maintenance/frontend_assets/services/pest1.webp" alt="Commercial Pest Control Hero" className="w-full h-full object-cover absolute inset-0" />
            {/* Floating Stats */}
            <motion.div 
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-gray-200 flex items-center justify-center min-h-[350px] relative">
              <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059044/care_maintenance/frontend_assets/services/pest2.webp" alt="Licensed and Certified" className="w-full h-full object-cover absolute inset-0" />
            </div>
      ...
      <section className="py-10 lg:py-16 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059045/care_maintenance/frontend_assets/services/pest3.webp" alt="Food Processing Unit" className="w-full h-full object-cover absolute inset-0 group-hover:scale-105 transition-transform duration-700" />
          ...
          <div className="flex flex-col gap-8">
            ...
            >
              <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059046/care_maintenance/frontend_assets/services/pest4.webp" alt="Commercial Kitchen Disinfestation" className="w-full h-full object-cover absolute inset-0 group-hover:scale-105 transition-transform duration-700" />
            ...
            <motion.div 
              ...
              className="group cursor-pointer rounded-[2rem] overflow-hidden relative h-[284px] bg-gray-200 flex items-center justify-center"
            >
              <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059047/care_maintenance/frontend_assets/services/pest5.webp" alt="Rodent Exclusion & Eradication" className="w-full h-full object-cover absolute inset-0 group-hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/80 to-transparent flex flex-col justify-end p-8 z-10">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
            ...
            <div className="w-full lg:w-[40%] order-1 lg:order-2">
              <div className="relative w-full aspect-[4/5] rounded-[24px] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.08)] bg-gray-200 flex items-center justify-center min-h-[350px]">
                <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059048/care_maintenance/frontend_assets/services/pest6.webp" alt="FAQ Background" className="w-full h-full object-cover absolute inset-0" />
