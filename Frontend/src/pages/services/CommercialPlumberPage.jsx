...
import { 
  ...
  Star, Phone, Mail, Award, Factory, Scissors, Coffee, Palette
} from 'lucide-react';
  ...
  return (
    <div className="bg-[#fafafa] min-h-screen text-gray-900 font-sans selection:bg-blue-200">
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.h1 variants={fadeInUp} className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-red-600 leading-[1.15] tracking-tight mb-6 min-h-[140px] md:min-h-[180px] lg:min-h-[220px] max-w-2xl text-balance">
              Commercial Plumbing, <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">Reliable & Simplified</span>
            </motion.h1>
      ...
      <section className="py-12 lg:py-24 max-w-7xl mx-auto px-4 lg:px-8">
        ...
        >
          <h2 className="text-3xl lg:text-5xl font-semibold tracking-tight mb-6 text-red-600">Comprehensive Commercial Property Solutions</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">Providing efficient and dependable plumbing services for properties of all types and sizes, with a commitment to quality, safety, and long-term performance</p>
        </motion.div>
      ...
      {/* 4.Comprehensive Commercial Plumbing Services  */}
