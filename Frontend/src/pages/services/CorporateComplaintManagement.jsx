    ...
    <div className="bg-[#fafafa] min-h-screen text-gray-900 font-sans selection:bg-blue-200">
      ...
      <section className="relative pt-16 pb-14 lg:pt-20 lg:pb-22 overflow-hidden px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783058961/care_maintenance/frontend_assets/services/admin_image_1.webp" alt="Corporate Complaint Management" className="absolute inset-0 w-full h-full object-cover" />
            {/* Floating Stats */}
            <motion.div 
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-gray-200 flex items-center justify-center min-h-[350px] bg-gradient-to-br from-gray-100 to-gray-50">
              <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783058963/care_maintenance/frontend_assets/services/admin_image_2.webp" alt="Comprehensive Solutions" className="w-full h-full object-cover" />
            </div>
      ...
      <section className="py-12 lg:py-18 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-4 gap-8 relative">
          {[
            { num: '01', title: 'Raise Ticket', desc: 'Query logged via portal, email, or dedicated hotline.', img: 'https://res.cloudinary.com/reuof8q6/image/upload/v1783058965/care_maintenance/frontend_assets/services/admin_image_4.webp' },
            { num: '02', title: 'Triage & Assign', desc: 'System categorizes and assigns to the right technician.', img: 'https://res.cloudinary.com/reuof8q6/image/upload/v1783058967/care_maintenance/frontend_assets/services/admin_image_5.webp' },
            { num: '03', title: 'Resolution', desc: 'On-site or remote support provided within SLA.', img: 'https://res.cloudinary.com/reuof8q6/image/upload/v1783058968/care_maintenance/frontend_assets/services/admin_image_6.webp' },
            { num: '04', title: 'Closure & QA', desc: 'Issue resolved, documented, and feedback collected.', img: 'https://res.cloudinary.com/reuof8q6/image/upload/v1783058970/care_maintenance/frontend_assets/services/admin_image_7.webp' }
          ].map((step, i) => (
            <motion.div 
              key={i}
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
            ...
            <div className="w-full lg:w-[40%] order-1 lg:order-2">
              <div className="relative w-full aspect-[4/5] rounded-[24px] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.08)] bg-gray-200 flex items-center justify-center min-h-[350px] bg-gradient-to-bl from-gray-100 to-gray-200">
                <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783058964/care_maintenance/frontend_assets/services/admin_image_3.webp" alt="FAQ Customer Care" className="absolute inset-0 w-full h-full object-cover" />
