  ...
  return (
    <div className="stitch-redesign">
      <main className="pt-12 pb-24 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto flex flex-col gap-12">
        ...
        <section className="bg-surface-container-lowest rounded-[2rem] p-8 md:p-12 border border-outline-variant/20 shadow-lg flex flex-col md:flex-row items-center gap-10 md:gap-14 relative overflow-hidden">
          ...
          <div className="flex-1 space-y-7 z-10 w-full">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-red-600 leading-[1.15] tracking-tight max-w-2xl text-balance">
                Expert Electrical <br />Safety & Service
              </h1>
          ...
          <div className="flex-1 w-full aspect-[4/3] md:aspect-[5/4] rounded-[2rem] overflow-hidden relative shadow-2xl group">
            {service.gallery && service.gallery.length > 0 && (
              <img src="https://res.cloudinary.com/reuof8q6/image/upload/v1783059016/care_maintenance/frontend_assets/services/elect_1.webp" alt="Electrical Service" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-in-out" />
            )}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
                ...
                <div className="lg:col-span-7 space-y-6 text-left pr-0 lg:pr-6 relative">
                  ...
                  <p className="text-gray-700 text-lg md:text-xl leading-relaxed font-semibold relative z-10 italic pl-4">
                    Our certified electricians deliver safe, reliable, and modern electrical solutions tailored for homes and businesses. From quick repairs and fault detection to complete wiring and smart installations, we ensure every job is handled with precision, transparency, and care. With fast response times, skilled professionals, and a commitment to quality workmanship, we make electrical services simple, secure, and stress-free for every customer.
                  </p>
                  ...
                  {[
                    {
                      ...
                      desc: "All work strictly complies with national safety standards."
                    },
                    {
                      icon: "bolt",
                      title: "Rapid Emergency Response",
                      desc: "Fast, reliable dispatch for urgent electrical concerns."
                    },
                    {
                      icon: "payments",
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative w-full overflow-hidden rounded-xl shadow-lg pt-[56.25%]">
              <iframe
                ...
                src="https://www.youtube.com/embed/795FTsDoRIw"
                title="YouTube Video"
                frameBorder="0"
        ...
        {/* === BEFORE & AFTER SLIDER === */}
        <BeforeAfterSlider 
          beforeImage="https://res.cloudinary.com/reuof8q6/image/upload/v1783059037/care_maintenance/frontend_assets/services/electrican_image_before.webp" 
          afterImage="https://res.cloudinary.com/reuof8q6/image/upload/v1783059039/care_maintenance/frontend_assets/services/electrician_image_after.webp" 
        />
