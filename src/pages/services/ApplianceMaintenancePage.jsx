        ...
        <section className="bg-surface-container-lowest rounded-[2rem] p-8 md:p-12 border border-outline-variant/20 shadow-lg flex flex-col md:flex-row items-center gap-10 md:gap-14 relative overflow-hidden">
          ...
          <div className="flex-1 space-y-7 z-10 w-full">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-3 pt-1">
              ...
              <div className="flex items-center gap-2 bg-surface-variant/30 px-3 py-1.5 rounded-lg border border-outline-variant/30 shadow-sm">
                <span className="text-primary text-[16px] font-bold">✔</span>
                <span className="text-sm text-surface-dark font-semibold tracking-wide">All Brands Covered</span>
              </div>
              <div className="flex items-center gap-2 bg-surface-variant/30 px-3 py-1.5 rounded-lg border border-outline-variant/30 shadow-sm">
                <span className="text-primary text-[16px] font-bold">✔</span>
                <span className="text-sm text-surface-dark font-semibold tracking-wide">Same Day Repair</span>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
                ...
                <div className="lg:col-span-7 space-y-6 text-left pr-0 lg:pr-6 relative">
                  ...
                  <p className="text-gray-700 text-lg md:text-xl leading-relaxed font-semibold relative z-10 italic pl-4">
                    Our certified technicians deliver fast, reliable, and professional repair solutions tailored for all your household appliances. From minor fixes and part replacements to complete overhauls, we ensure every job is handled with precision and transparency. With quick response times, skilled experts, and a commitment to quality parts, we make appliance maintenance simple, secure, and stress-free for every customer.
                  </p>
                  ...
                  {[
                    {
                      ...
                      desc: "We use authentic components to ensure durability and performance."
                    },
                    {
                      icon: "timer",
                      title: "Rapid Emergency Response",
                      desc: "Fast, reliable dispatch for urgent appliance breakdowns."
                    },
                    {
                      icon: "payments",
          ...
          <div className="flex flex-col md:flex-row gap-12">
            <div className="w-full md:w-1/3 flex flex-col gap-4 border-r-0 md:border-r border-blue-200 pr-0 md:pr-8">
              ...
              <p className="text-lg text-text-muted leading-relaxed font-medium">
                We handle everything from washing machine motor repairs to TV motherboard fixes. No job is too complex for our <strong className="text-secondary font-bold">expert technicians</strong>.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative w-full overflow-hidden rounded-xl shadow-lg pt-[56.25%]">
              <iframe
                ...
                src="https://www.youtube.com/embed/Rgw3mQca81E"
                title="YouTube Video"
                frameBorder="0"
        ...
        <section className="space-y-12 pt-16 relative">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-text-muted font-medium max-w-2xl mx-auto leading-relaxed">
              Professional, certified, and cleanly finished appliance repairs for your peace of mind.
            </p>
          </div>
