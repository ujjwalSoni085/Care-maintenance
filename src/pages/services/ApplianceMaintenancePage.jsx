...
const ApplianceMaintenancePage = () => {
  const service = serviceData['appliance-maintenance'];
      ...
      <main className="pt-12 pb-24 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto flex flex-col gap-12">
        ...
        <section className="bg-surface-container-lowest rounded-[2rem] p-8 md:p-12 border border-outline-variant/20 shadow-lg flex flex-col md:flex-row items-center gap-10 md:gap-14 relative overflow-hidden">
          ...
          <div className="flex-1 space-y-7 z-10 w-full">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-red-600 leading-[1.1] tracking-tight">
                {service.headline || "Fast and Reliable Repair for All Your Home Appliances"}
              </h1>
              <p className="text-lg md:text-xl text-text-muted leading-relaxed max-w-lg font-medium">
                {service.description || "Don't let a broken appliance disrupt your routine. Our technicians provide quick repairs for washing machines, refrigerators, ovens, and more."}
              </p>
            </div>
          ...
          <div className="flex-1 w-full aspect-[4/3] md:aspect-[5/4] rounded-[2rem] overflow-hidden relative shadow-2xl group">
            <img src="/images/services/elect1.webp" alt="Appliance Service" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-in-out" />
          ...
          <div className="max-w-6xl mx-auto text-center space-y-8 px-4 sm:px-6">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-200/50 text-blue-600 flex items-center justify-center shadow-sm relative z-10">
                <span className="material-symbols-outlined text-3xl font-black animate-pulse" style={{ fontVariationSettings: "'FILL' 1" }}>kitchen</span>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
                ...
                <div className="lg:col-span-7 space-y-6 text-left pr-0 lg:pr-6 relative">
                  ...
                  <p className="text-gray-700 text-lg md:text-xl leading-relaxed font-semibold relative z-10 italic pl-4">
                    Our certified technicians deliver professional, energy-efficient, and comprehensive repair solutions for all major household appliances. From refrigerators and washing machines to ovens and microwaves, we ensure every unit is restored to peak performance. With rapid response times, skilled professionals, and a commitment to quality, we make appliance repairs simple, reliable, and stress-free for every customer.
                  </p>
                  ...
                  {[
                    {
                      ...
                      desc: "All technicians are fully certified for major appliance brands."
                    },
                    {
                      icon: "bolt",
                      title: "Rapid Emergency Response",
                      desc: "Fast, reliable dispatch for urgent repair needs."
                    },
                    {
                      icon: "payments",
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative w-full overflow-hidden rounded-xl shadow-lg pt-[56.25%]">
              <iframe
                ...
                src="https://www.youtube.com/embed/Gr-cTMZhDcw?si=yN9x86Q1o_f3jK4a"
                title="YouTube Video"
                frameBorder="0"
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto px-2">
            {[
              ...
              <div key={index} className="group relative aspect-video md:aspect-square bg-surface-container-lowest rounded-3xl overflow-hidden border border-outline-variant/30 shadow-lg hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 ease-out hover:-translate-y-2 cursor-pointer">
                ...
                <img src={imgSrc} alt={`Appliance Service Work ${index + 1}`} className="w-full h-full object-cover group-hover:scale-110 group-hover:brightness-110 transition-all duration-700 ease-out" />
