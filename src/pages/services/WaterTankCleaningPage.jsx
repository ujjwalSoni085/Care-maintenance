...
const WaterTankCleaningPage = () => {
  const service = serviceData['water-tank-cleaning'];
          ...
          <div className="flex-1 space-y-7 z-10 w-full">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-3 pt-1">
              <div className="flex items-center gap-2 bg-surface-variant/30 px-3 py-1.5 rounded-lg border border-outline-variant/30 shadow-sm">
                ...
                <span className="text-sm text-surface-dark font-semibold tracking-wide">Certified Cleaners</span>
              </div>
              <div className="flex items-center gap-2 bg-surface-variant/30 px-3 py-1.5 rounded-lg border border-outline-variant/30 shadow-sm">
                <span className="text-primary text-[16px] font-bold">✔</span>
                <span className="text-sm text-surface-dark font-semibold tracking-wide">Eco-Friendly</span>
              </div>
              <div className="flex items-center gap-2 bg-surface-variant/30 px-3 py-1.5 rounded-lg border border-outline-variant/30 shadow-sm">
                <span className="text-primary text-[16px] font-bold">✔</span>
                <span className="text-sm text-surface-dark font-semibold tracking-wide">Deep Cleaning Guaranteed</span>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto text-center space-y-8 px-4 sm:px-6">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-200/50 text-blue-600 flex items-center justify-center shadow-sm relative z-10">
                <span className="material-symbols-outlined text-3xl font-black animate-pulse" style={{ fontVariationSettings: "'FILL' 1" }}>water_drop</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-extrabold text-red-600 tracking-tight font-heading">
                About Our Tank Cleaning
              </h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
                ...
                <div className="lg:col-span-7 space-y-6 text-left pr-0 lg:pr-6 relative">
                  ...
                  <p className="text-gray-700 text-lg md:text-xl leading-relaxed font-semibold relative z-10 italic pl-4">
                    Our specialized cleaners deliver thorough, hygienic, and professional cleaning solutions tailored for all types of water tanks. From mechanized dewatering and sludge removal to UV sterilization, we ensure every drop of water in your home is safe and pure. With advanced technology, eco-friendly processes, and a commitment to health standards, we make water tank maintenance simple, secure, and stress-free.
                  </p>
                  ...
                  {[
                    {
                      ...
                      desc: "Using modern equipment for deep cleaning."
                    },
                    {
                      icon: "format_list_numbered",
                      title: "Multi-Stage Process",
                      desc: "Thorough 6-step professional cleaning method."
                    },
                    {
                      icon: "health_and_safety",
                      title: "Health First",
                      desc: "Prevents waterborne diseases and infections."
                    }
                  ].map((pillar, idx) => (
                    <div 
                      key={idx} 
          ...
          <div className="flex flex-col md:flex-row gap-12">
            <div className="w-full md:w-1/3 flex flex-col gap-4 border-r-0 md:border-r border-blue-200 pr-0 md:pr-8">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-red-600 mb-4 tracking-tight leading-tight">
                Comprehensive <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">Cleaning</span>
              </h2>
              <p className="text-lg text-text-muted leading-relaxed font-medium">
                We handle everything from sludge removal to UV sterilization. No job is too complex for our <strong className="text-secondary font-bold">expert cleaners</strong>.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative w-full overflow-hidden rounded-xl shadow-lg pt-[56.25%]">
              <iframe
                ...
                src="https://www.youtube.com/embed/Vo8XlPsNFYc?si=g-hZTyJI9jzwSc07"
                title="YouTube Video"
                frameBorder="0"
        ...
        <section className="space-y-12 pt-16 relative">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-text-muted font-medium max-w-2xl mx-auto leading-relaxed">
              Professional, hygienic, and deeply cleaned water tanks for your peace of mind.
            </p>
          </div>
